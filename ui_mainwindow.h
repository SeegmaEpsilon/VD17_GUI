...
**
** Created: Mon 16. Jan 19:42:04 2023
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(canvas, 0, 3, 8, 1);
        ...
        UART_output->setMinimumSize(QSize(500, 0));
        ...
        sizePolicy4.setHeightForWidth(pushButton_clear_console->sizePolicy().hasHeightForWidth());
        pushButton_clear_console->setSizePolicy(sizePolicy4);
        ...
        gridLayout->addLayout(horizontalLayout_4, 8, 3, 1, 1);
