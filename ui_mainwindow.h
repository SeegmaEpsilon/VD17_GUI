...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_DL_calibration->setEnabled(false);
        ...
        pushButton_constant_value_write->setEnabled(false);

        gridLayout->addWidget(pushButton_constant_value_write, 8, 3, 1, 2);
        ...
        pushButton_thermoslope_set->setEnabled(false);
        ...
        gridLayout->addWidget(menuClear, 15, 7, 1, 1);
        ...
        pushButton_dynamic_range_set->setEnabled(false);
...
"}"));
        ...
        gridLayout->addWidget(pushButton_manual, 15, 6, 1, 1);
        ...
        pushButton_thermointercept_write->setEnabled(false);

        gridLayout->addWidget(pushButton_thermointercept_write, 7, 3, 1, 2);
        ...
        gridLayout->addWidget(checkBox_need_plot, 15, 5, 1, 1);
        ...
        pushButton_constant_value_set->setEnabled(false);

        gridLayout->addWidget(pushButton_constant_value_set, 8, 0, 1, 2);
        ...
        gridLayout->addWidget(canvas, 0, 5, 15, 4);
        ...
        gridLayout->addWidget(pushButton_settings, 15, 8, 1, 1);
        ...
        gridLayout->addWidget(UART_output, 10, 0, 6, 5);
        ...
        pushButton_thermointercept_set->setEnabled(false);

        gridLayout->addWidget(pushButton_thermointercept_set, 7, 0, 1, 2);
        ...
        pushButton_UL_calibration->setEnabled(false);
        ...
        pushButton_calibrate_device->setEnabled(false);
        ...
        pushButton_mmpersec_calibration->setEnabled(false);
        ...
        pushButton_default_settings_set->setEnabled(false);
...
"}"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_thermoslope_set->setText(QCoreApplication::translate("MainWindow", "\320\230\320\267\320\274\320\265\320\275\320\265\320\275\320\270\320\265 \320\272\320\276\321\215\321\204\321\204\320\270\321\206\320\270\320\265\320\275\321\202\320\260 \321\202\320\265\321\200\320\274\320\276\320\277\321\200\321\217\320\274\320\276\320\271", nullptr));
        ...
        pushButton_constant_value_set->setText(QCoreApplication::translate("MainWindow", "\320\230\320\267\320\274\320\265\320\275\320\265\320\275\320\270\320\265 \320\277\320\276\321\201\321\202\320\276\321\217\320\275\320\275\320\276\320\263\320\276 \320\267\320\275\320\260\321\207\320\265\320\275\320\270\321\217", nullptr));
        ...
        lineEdit_constant_value->setText(QCoreApplication::translate("MainWindow", "-1.00", nullptr));
