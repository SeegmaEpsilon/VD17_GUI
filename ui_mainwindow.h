...
**
** Created: Mon 23. Jan 15:30:34 2023
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(pushButton_calibrate_device, 8, 0, 1, 7);
        ...
        gridLayout->addWidget(pushButton_UL_write, 2, 6, 1, 1);
        ...
        gridLayout->addWidget(pushButton_dynamic_range_write, 4, 5, 1, 2);
        ...
        gridLayout->addWidget(lineEdit_average_V, 6, 6, 1, 1);
        ...
        gridLayout->addWidget(pushButton_DL_write, 1, 6, 1, 1);
        ...
        gridLayout->addWidget(UART_output, 7, 0, 1, 7);
        ...
        gridLayout->addWidget(pushButton_mmpersec_write, 3, 5, 1, 2);
        ...
        gridLayout->addWidget(pushButton_COM_connect, 0, 5, 1, 2);
        ...
        gridLayout->addWidget(lineEdit_RMS_V, 6, 5, 1, 1);
        ...
        gridLayout->addWidget(lineEdit_RMS_A, 5, 5, 1, 1);
        ...
        gridLayout->addWidget(lineEdit_average_A, 5, 6, 1, 1);
