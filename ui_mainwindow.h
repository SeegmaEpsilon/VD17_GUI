...
**
** Created: Mon 26. Jun 16:11:34 2023
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        checkBox_need_plot = new QCheckBox(canvas);
        checkBox_need_plot->setObjectName(QString::fromUtf8("checkBox_need_plot"));
        checkBox_need_plot->setGeometry(QRect(499, 0, 21, 20));
...
"}"));
        ...
        gridLayout->addWidget(pushButton_manual, 12, 5, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        checkBox_need_plot->setText(QString());
