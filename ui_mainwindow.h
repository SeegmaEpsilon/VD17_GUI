...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(pushButton_calibrate_device, 13, 0, 1, 2);
...
"}"));
        ...
        gridLayout->addWidget(pushButton_thermointercept_write, 9, 3, 1, 2);
        ...
        gridLayout->addWidget(lineEdit_thermo_lowTemperature_constant, 10, 2, 1, 1);
        ...
        gridLayout->addWidget(canvas, 0, 5, 20, 5);
        ...
        gridLayout->addWidget(pushButton_thermointercept_set, 9, 0, 1, 2);
        ...
        sizePolicy3.setHeightForWidth(pushButton_manual->sizePolicy().hasHeightForWidth());
        pushButton_manual->setSizePolicy(sizePolicy3);
...
"}"));
        ...
        gridLayout->addWidget(pushButton_manual, 20, 6, 1, 1);
        ...
        gridLayout->addWidget(lineEdit_thermointercept, 9, 2, 1, 1);
        ...
        gridLayout->addWidget(lineEdit_thermoslope, 8, 2, 1, 1);
        ...
        gridLayout->addWidget(pushButton_thermohelp, 20, 7, 1, 1);
        ...
        gridLayout->addWidget(pushButton_constant_value_set, 11, 0, 1, 2);
        ...
        gridLayout->addWidget(pushButton_thermo_lowTemperature_constant_write, 10, 3, 1, 2);
        ...
        gridLayout->addWidget(lineEdit_constant_value, 11, 2, 1, 1);
        ...
        gridLayout->addWidget(pushButton_axis_write, 13, 3, 1, 2);
        ...
        gridLayout->addWidget(pushButton_settings, 20, 9, 1, 1);
        ...
        gridLayout->addWidget(pushButton_thermoslope_set, 8, 0, 1, 2);
        ...
        gridLayout->addWidget(pushButton_thermo_lowTemperature_constant_set, 10, 0, 1, 2);
        ...
        gridLayout->addWidget(checkBox_need_plot, 20, 5, 1, 1);

        menuClear = new QPushButton(centralWidget);
        menuClear->setObjectName(QString::fromUtf8("menuClear"));
        sizePolicy3.setHeightForWidth(menuClear->sizePolicy().hasHeightForWidth());
        menuClear->setSizePolicy(sizePolicy3);

        gridLayout->addWidget(menuClear, 20, 8, 1, 1);
        ...
        gridLayout->addWidget(pushButton_constant_value_write, 11, 3, 1, 2);
        ...
        gridLayout->addWidget(UART_output, 15, 0, 6, 5);
        ...
        gridLayout->addWidget(pushButton_thermoslope_write, 8, 3, 1, 2);
        ...
        gridLayout->addWidget(cmb_axis, 13, 2, 1, 1);
        ...
        cmb_axis_measuring->setMaximumSize(QSize(60, 16777215));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_measuring_axis_set->setText(QCoreApplication::translate("MainWindow", "\320\243\321\201\321\202\320\260\320\275\320\276\320\262\320\272\320\260 \320\270\320\267\320\274\320\265\321\200\321\217\320\265\320\274\320\276\320\271 \320\276\321\201\320\270", nullptr));
