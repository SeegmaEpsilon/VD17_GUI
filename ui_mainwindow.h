...
"}"));
        ...
        gridLayout->addWidget(pushButton_manual, 16, 6, 1, 1);
        ...
        gridLayout->addWidget(pushButton_constant_value_write, 9, 3, 1, 2);
        ...
        gridLayout->addWidget(menuClear, 16, 7, 1, 1);
        ...
        gridLayout->addWidget(pushButton_constant_value_set, 9, 0, 1, 2);
        ...
        gridLayout->addWidget(UART_output, 11, 0, 6, 5);
        ...
        lineEdit_mmpersec_value->setEnabled(true);
        ...
        gridLayout->addWidget(checkBox_need_plot, 16, 5, 1, 1);
...
"}"));
        ...
        gridLayout->addWidget(pushButton_settings, 16, 8, 1, 1);
        ...
        gridLayout->addWidget(canvas, 0, 5, 16, 4);
        ...
        gridLayout->addWidget(lineEdit_constant_value, 9, 2, 1, 1);
        ...
        gridLayout->addWidget(pushButton_thermo_lowTemperature_constant_set, 8, 0, 1, 2);
        ...
        gridLayout->addWidget(lineEdit_thermo_lowTemperature_constant, 8, 2, 1, 1);
        ...
        gridLayout->addWidget(pushButton_thermo_lowTemperature_constant_write, 8, 3, 1, 2);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lineEdit_constant_value->setText(QCoreApplication::translate("MainWindow", "-1.000", nullptr));
        ...
        pushButton_thermo_lowTemperature_constant_set->setText(QCoreApplication::translate("MainWindow", "\320\230\320\267\320\274\320\265\320\275\320\265\320\275\320\270\320\265 \320\272\320\276\320\275\321\201\321\202\320\260\320\275\321\202\321\213 \320\275\320\270\320\267\320\272\320\270\321\205 \321\202\320\265\320\274\320\277\320\265\321\200\320\260\321\202\321\203\321\200", nullptr));
