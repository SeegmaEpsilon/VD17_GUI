...
**
** Created: Wed 22. Feb 19:06:42 2023
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        sizePolicy.setHeightForWidth(pushButton_clear_console->sizePolicy().hasHeightForWidth());
        pushButton_clear_console->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(pushButton_clear_canvas->sizePolicy().hasHeightForWidth());
        pushButton_clear_canvas->setSizePolicy(sizePolicy);
        ...
        gridLayout->addWidget(canvas, 0, 5, 9, 2);
